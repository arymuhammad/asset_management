                          ...
                          !adjC.canSubmitOut
                              ...
                              : () async {
                                if (id != ""
                                  ...
                                  await adjC.saveAdjOut(
                                    id != "" ? id! : "",
                                    id != "" ? "update_data" : "add_adjOut",
                                  );
                                  adjC.resetForm();
                                } else {
                                  failedDialog(
                    ...
                    onPressed: () async {
                      promptDialog(
                        ...
                        () async {
                          ...
                          await adjC.acceptAdjOut(id!, author!);
                        },
                        isWideScreen,
                      );
                    },
                      ...
                      if (statusData != "" &&
                        ...
                        promptDialog(
                          ...
                          () async {
                            Get.back();
                            loadingDialog('Memproses data...', "");
                            await adjC.rejectAdjOut(id!, author!);
                          },
                          isWideScreen,
                        );
                      } else {
